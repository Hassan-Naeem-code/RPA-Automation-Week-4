...
class LoggerManager:
    ...
    def get_performance_logger() -> logging.Logger:
        ...
        return logging.getLogger('flight_automation.performance')
    
    @staticmethod
    def get_audit_logger() -> logging.Logger:
        """Get the audit trail logger."""
        return logging.getLogger('flight_automation.audit')
...
def get_logger(name: str = 'flight_automation') -> logging.Logger:
    """Get a logger with the specified name."""
